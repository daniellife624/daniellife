    ...
    <div class="finance__inner">
      ...
      <div class="finance__body">
        <div class="charts-row">
          ...
          <div class="charts-row__item">
            <h3 class="charts-col__title">券商分布</h3>
...
.finance__body { display: flex; flex-direction: column; gap: var(--space-6); width: 100%; }

.charts-row { display: flex; flex-direction: row; gap: var(--space-6); }
.charts-row__item { flex: 1; display: flex; flex-direction: column; align-items: center; gap: var(--space-3); }
